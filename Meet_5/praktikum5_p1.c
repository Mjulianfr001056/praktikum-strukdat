...
int main(){
	...
	printf("\n\nKondisi setelah pushBack\n");
	printDLL(my_list, false);
	
	//insert di tengah setelah posisi x
	...
	printf("\n\nKondisi setelah insert after\n");
	printDLL(my_list, false);
	
	//insert di tengah sebelum posisi x
	...
	printf("\n\nKondisi setelah insert before\n");
	printDLL(my_list, false);
	
	//menghapus elemen pertama di list
	my_list = DLL_pop(my_list);
	my_list = DLL_pop(my_list);
	my_list = DLL_pop(my_list);
	my_list = DLL_pop(my_list);
	my_list = DLL_pop(my_list);
	...
	//menghapus elemen pertama di list
	my_list = DLL_popBack(my_list);
	my_list = DLL_popBack(my_list);
	my_list = DLL_popBack(my_list);
	my_list = DLL_popBack(my_list);
	my_list = DLL_popBack(my_list);
	
	printf("\n\nKondisi setelah popBack\n");
	printDLL(my_list, false);
	
	printf("\n\nPrint dari belakang\n");
	printDLL(my_list, true);
}
